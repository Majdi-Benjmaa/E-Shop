...
const Footer = ({
  ...
  const shouldRedirect = (redirect) => {
    ...
    //This code is a function that checks whether a redirect flag is set to true. If the flag is true, it returns a Redirect component from the react-router-dom library that redirects the user to the /cart page.
  };
  ...
  const handleChange = (productId) => (e) => {
    setRender(!render); //re-render setItem in session
